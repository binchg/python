...
class tm(object):  ####手机端
    ...
    def goodsid(self, url):  ###通过店铺URL获取店铺所有ID
        ...
        searchurl = 'https://{}.m.tmall.com/shop/shop_auction_search.do?spm=a1z60.7754813.0.0.301755f0pZ1GjU&sort=defaul'.format(shopname)
        s = requests.session()
        headers = {'Accept': '*/*',
...
if __name__ == '__main__':
    path = r'.\\temp\\'
    tm = tm(path)
    df = tm.goodsid('https://kxcbs.tmall.com')
    tm.iddata(df)
